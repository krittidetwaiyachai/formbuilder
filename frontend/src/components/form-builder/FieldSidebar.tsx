  ...
  return (
    <div
      ...
      <button
        ...
        className={`p-4 border-b border-gray-200 flex items-center ${isCollapsed ? "justify-center" : "justify-between"} bg-white relative`}>
        {!isCollapsed &&
        <h2 className="font-semibold text-gray-800 whitespace-nowrap overflow-hidden">            {t("builder.fields")}          </h2>
        }      </div>      <div
        className={`border-b border-gray-100 bg-gray-50/50 ${isCollapsed ? "p-2" : "px-4 py-4"}`}>
        {isCollapsed ?
        <button
        ...
        <Droppable
          ...
          <div
            ...
            className={
            visualVariant === "list" ? "space-y-6" : "space-y-8 pb-10"
            }>
