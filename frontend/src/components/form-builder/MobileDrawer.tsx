...
// Tune label offsets separately depending on whether the FAB is on the left or right side.
          ...
          <div
            className={`mobile-drawer-panel relative w-full max-w-[92%] md:max-w-[400px] h-full bg-white shadow-2xl animate-in transition-opacity ${
              drawerContent === "fields"
                ...
                : "slide-in-from-right ml-auto md:rounded-l-2xl"
            } duration-300 flex flex-col overflow-visible opacity-100`}
          >
            {drawerContent !== "fields" && (
          ...
          {actions.map((action, index) => {
            ...
            const actionLabelStyle: CSSProperties = {
              ...
              marginTop: `${
                ...
                (activeLabelYAdjustments[action.key] ?? 0)
              }px`
            };
            return (
              <button
