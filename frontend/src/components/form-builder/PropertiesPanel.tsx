...
export default function PropertiesPanel({
  ...
  const isPageBreak = selectedField?.type === FieldType.PAGE_BREAK;
  useEffect(() => {
    if ((!selectedField || isPageBreak) && activeSidebarTab === "properties") {
      setActiveSidebarTab("settings");
    }
  }, [selectedField, isPageBreak, activeSidebarTab, setActiveSidebarTab]);
  ...
  {
    if (key === "properties" && (!selectedField || isPageBreak)) {
      return null;
    }
