...
import { SidebarFieldConfig, allFields } from './config';
import { useFieldLabels, getFieldColorTheme } from './useSidebarTheme';

const FieldTypeButtonVisual = ({ fieldType, isCollapsed, variant = 'list' }: { fieldType: SidebarFieldConfig, isCollapsed?: boolean, variant?: 'list' | 'grid' }) => {
...
export function FieldTypeButton({ fieldType, isCollapsed, onFieldAdd, variant, isTouch }: { fieldType: SidebarFieldConfig, isCollapsed?: boolean, onFieldAdd?: () => void, variant?: 'list' | 'grid', isTouch?: boolean }) {
