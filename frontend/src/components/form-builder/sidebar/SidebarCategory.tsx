...
import { SidebarFieldConfig } from './config';
import { useFieldLabels } from './useSidebarTheme';
import { FieldTypeButton } from './FieldTypeButton';

export function SidebarCategory({ category, isCollapsed, onFieldAdd, variant, isTouch }: { category: { name: string; fields: SidebarFieldConfig[] }, isCollapsed: boolean, onFieldAdd?: () => void, variant?: 'list' | 'grid', isTouch?: boolean }) {
