...
import type { Field, TextareaFieldOptions, LongTextValidation } from "@/types";
import {
  FileText,
  Bold,
  Italic,
  ...
  if (isRichText) {
    return (
      <div
        ...
        <div
          className={`w-full border ${fieldStyle.inputBorder} rounded-xl overflow-hidden bg-white shadow-sm resize-none transition-all duration-300 ${disabledClass} pointer-events-none group-hover/field:shadow-md`}>
