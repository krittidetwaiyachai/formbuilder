      ...
      <div className="px-4 py-3 md:px-6 md:py-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() =>
                window.open(`/forms/${currentForm?.id}/preview`, "_blank")
              }
          ...
          <DialogContent className="sm:max-w-md bg-white">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                {}
                <div
                  className={`absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-black text-white text-xs rounded shadow-lg transition-all duration-200 pointer-events-none whitespace-nowrap ${isCopied ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
                >
                  {t("common.copied")}
                  {}
