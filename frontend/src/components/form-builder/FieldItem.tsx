    ...
    <>
        <div className={`flex items-center gap-3 transition-all duration-200 ${
          ...
          >
            ...
            {(field.validation?.hidden || (field.options?.hidden as boolean)) && !isOverlay && !isDragging && (
              ...
              {field.type === FieldType.HEADER || field.type === FieldType.PARAGRAPH || field.type === FieldType.DIVIDER || field.type === FieldType.PAGE_BREAK ? (
                ...
                <>
                   {(isOverlay || isDragging) ? (
                        ...
                        // Modified to use FieldLabel wrapper for slot capability if needed, or adjust FieldLabel to accept children
                       // Actually, FieldLabel wraps the layout logic, so we should use it to wrap the preview
                       <FieldLabel 
                            field={field} 
                            isSelected={isSelected} 
                            isMultiSelecting={isMultiSelecting} 
