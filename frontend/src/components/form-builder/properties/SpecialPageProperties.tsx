...
export function SpecialPageProperties({
  currentPage,
  currentForm,
  handleFormUpdate
}: SpecialPagePropertiesProps) {
  ...
  { id: "smile", icon: Smile },
  { id: "eye", icon: Eye },
  { id: "cake", icon: Cake }] as
  const;
  const iconColors = [
  {
    id: "green",
    label: t("builder.special.color.green"),
    color: "bg-gradient-to-br from-emerald-400 to-green-500"
  },
  {
    id: "blue",
    label: t("builder.special.color.blue"),
    color: "bg-gradient-to-br from-blue-400 to-blue-500"
  },
  {
    id: "purple",
    label: t("builder.special.color.purple"),
    color: "bg-gradient-to-br from-purple-400 to-purple-500"
  },
  {
    id: "orange",
    label: t("builder.special.color.orange"),
    color: "bg-gradient-to-br from-orange-400 to-orange-500"
  },
  {
    id: "pink",
    label: t("builder.special.color.pink"),
    color: "bg-gradient-to-br from-pink-400 to-pink-500"
  },
  {
    id: "red",
    label: t("builder.special.color.red"),
    color: "bg-gradient-to-br from-red-400 to-red-500"
  },
  {
    id: "yellow",
    label: t("builder.special.color.yellow"),
    color: "bg-gradient-to-br from-yellow-400 to-yellow-500"
  },
  {
    id: "gray",
    label: t("builder.special.color.gray"),
    color: "bg-gradient-to-br from-gray-600 to-gray-800"
  },
  {
    id: "white",
    label: t("builder.special.color.white"),
    color: "bg-white border border-gray-200 shadow-sm"
  }];
  const activeSettings = isWelcome ?
  ...
  const updateSetting = (key: string, value: unknown) => {
    ...
    const currentSettings = isWelcome ?
    currentForm.welcomeSettings :
    currentForm.thankYouSettings;
  ...
  const SectionHeader = ({
    ...
    section,
    icon: Icon
  }: {title: string;section: string;icon: React.ElementType;}) =>
  <button
  ...
  return (
    <div className="space-y-4">      {}      <div className="border-b border-gray-100 pb-4">        <SectionHeader
          title={t("builder.special_page.appearance")}
          section="style"
          icon={Palette} />
        ...
        <div className="mt-3 space-y-4 animate-in fade-in slide-in-from-top-1 duration-200">          <div>            <label className="block text-xs font-medium text-gray-500 mb-2">              {t("builder.special_page.icon")}            </label>            <div className="max-h-40 overflow-y-auto rounded-lg border border-gray-100 p-2">              <div className="grid grid-cols-6 gap-1.5">                {availableIcons.map((item) =>
                <button
                  ...
                  className={`
                        ...
                        ${
                  (activeSettings?.icon || (
                  isWelcome ? "sparkles" : "check")) === item.id ?
              ...
              <button
                ...
                className={`
                        ...
                        ${
                activeSettings?.iconColor === color.id ||
      ...
      <div className="border-b border-gray-100 pb-4">        <SectionHeader
        ...
        <div className="mt-3 space-y-4 animate-in fade-in slide-in-from-top-1 duration-200">          {}          <div className="space-y-3">            <label className="flex items-center justify-between cursor-pointer">              <span className="text-sm font-medium text-gray-600">                {t("builder.special_page.auto_redirect")}              </span>              <div className="relative">                <input
                  ...
                  checked={
                  currentForm.thankYouSettings?.autoRedirect || false
                  }
                  onChange={(e) =>
            ...
            <div className="animate-in fade-in slide-in-from-top-1 duration-200 space-y-3">              <div>                <label className="block text-xs font-medium text-gray-500 mb-1">                  {t("builder.special_page.redirect_url")}                </label>                <input
                  ...
                  placeholder={t(
                    "builder.special_page.redirect_url_placeholder"
                  )}
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:border-black focus:ring-1 focus:ring-black outline-none transition-all"
                  placeholder={t(
                    "builder.special_page.delay_placeholder"
                  )}
                  ...
                  className="sr-only peer"
                  checked={
                  currentForm.thankYouSettings?.showConfetti ?? false
                  }
                  onChange={(e) =>
                  ...
                  className="sr-only peer"
                  checked={
                  currentForm.thankYouSettings?.showButton ?? false
                  }
                  onChange={(e) =>
            ...
            <div className="animate-in fade-in slide-in-from-top-1 duration-200 space-y-3">              <div>                <label className="block text-xs font-medium text-gray-500 mb-1">                  {t("builder.special_page.button_text")}                </label>                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:border-black focus:ring-1 focus:ring-black outline-none transition-all"
                  placeholder={t(
                    "builder.special_page.button_link_placeholder"
                  )}
