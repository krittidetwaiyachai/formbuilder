...
export const PreviewDateField: React.FC<PreviewFieldProps> = ({
  ...
  const dateFieldAnchorRef = useRef<HTMLDivElement>(null);
  const timeFieldAnchorRef = useRef<HTMLDivElement>(null);
