...
export const PreviewHeaderField: React.FC<PreviewFieldProps> = ({ field }) => {
  ...
  if (field.type === FieldType.HEADER) {
    const headerValidation = (field.validation ||
    {}) as ExtendedHeaderValidation;
            ...
            <h2
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                  field.label ||
                  t("public.placeholder.default_heading", "Heading")
                }} />
            </h2>            {headerSubheading &&
            <div
  ...
  if (field.type === FieldType.PARAGRAPH) {
    return (
      <div className="mb-4">        <p
          ...
          field.label ||
          t(
            "public.placeholder.default_paragraph",
            "This is a paragraph. You can add descriptive text here to provide instructions or additional information to your form users."
          )}        </p>      </div>);
  }
  if (field.type === FieldType.DIVIDER) {
    return (
      <div className="my-6">        <hr
          ...
          style={{ borderColor: "var(--divider, transparent)" }} />
      </div>);
  }
  if (field.type === FieldType.SECTION_COLLAPSE) {
    ...
    return (
      <div className="mb-4">        <div
          ...
          style={{
            borderColor: "var(--divider, transparent)",
            borderWidth: "1px"
          }}
          onClick={() => setIsCollapsed(!isCollapsed)}>
          <div className="flex items-center justify-between">            <h3 className="font-semibold" style={{ color: "var(--text)" }}>              {field.label ||
              t("public.placeholder.section_title", "Section Title")}            </h3>            <ChevronRight
