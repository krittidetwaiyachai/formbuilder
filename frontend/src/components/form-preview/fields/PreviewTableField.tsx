...
import type { Field, TableField, Column } from "@/types";
...
export const PreviewTableField: React.FC<PreviewFieldProps> = ({
  field,
  register,
  errors,
  control,
  ...
  { id: "c1", label: t("public.table.column", { index: 1 }) },
  { id: "c2", label: t("public.table.column", { index: 2 }) }];
  const allowAddRow =
  typedField.options?.allowAddRow !== undefined ?
  typedField.options.allowAddRow :
  true;
    ...
    <div className="mb-6 w-full">      <div className="mb-2">        <PreviewLabel
        ...
        <p className="mt-1 text-sm text-gray-500 font-normal">            {stripHtml(typedField.options.subLabel)}          </p>
            ...
            <thead
              ...
              <tr>                <th
                  scope="col"
                  className="px-4 py-3 border w-10 text-center"
                ...
                <th
                  scope="col"
                  className="px-2 py-3 border w-10"
              ...
              <tr
                ...
                style={{
                  ...
                  <td
                  className="px-4 py-2 border text-center text-xs font-medium"
                  style={{
                    borderColor: "var(--card-border)",
                    color: "var(--text)",
                    opacity: 0.5
