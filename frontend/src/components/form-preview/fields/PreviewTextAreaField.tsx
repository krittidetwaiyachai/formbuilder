      ...
      <div
        ...
        <p className="mt-1 text-sm text-gray-500 font-normal">{subLabel}</p>
          ...
          <textarea
            ...
            fieldError ?
            "border-red-500 bg-red-50" :
            "border-gray-300 bg-white"} rounded-lg text-black text-sm shadow-sm resize-none focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-all ${
