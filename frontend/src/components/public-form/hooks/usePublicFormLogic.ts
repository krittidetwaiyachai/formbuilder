...
export function usePublicFormLogic({
  ...
  const verification = useFormVerification({
    ...
    isPreview,
    sessionKey: draftPersistence.sessionKey,
    ...
    redirectBindingId: verificationRedirect?.bindingId,
    redirectToken: verificationRedirect?.token
  });
  ...
  const {
    ...
    grantToken: verification.grantToken,
