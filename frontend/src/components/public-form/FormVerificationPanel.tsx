  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        {grantExpiresAt && verificationStatus === 'verified' && (
          <p className="text-xs" style={{ color: 'var(--text)', opacity: 0.65 }}>
            Verification available until {new Date(grantExpiresAt).toLocaleString()}.
          </p>
        )}
