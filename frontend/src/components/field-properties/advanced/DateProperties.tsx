...
import { Field, DateField, DateValidation, DateFieldOptions } from '@/types';
...
export const DateProperties: React.FC<DatePropertiesProps> = ({ field: rawField, updateField, duplicatesField }) => {
  ...
  const handleValidationUpdate = (key: keyof DateValidation, value: unknown) => {
    handleUpdate({
      validation: {
        ...validation,
        [key]: value,
  ...
  return (
    <div className="space-y-4">
      {/* <h3 className="font-semibold mb-2">{t('builder.properties.date_properties')}</h3> */}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) => handleValidationUpdate('disablePastDates', e.target.checked)}
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all after:duration-300 after:ease-in-out after:shadow-sm peer-checked:bg-black"></div>
            </label>
          ...
          <div>
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) => handleValidationUpdate('disableFutureDates', e.target.checked)}
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all after:duration-300 after:ease-in-out after:shadow-sm peer-checked:bg-black"></div>
            </label>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleValidationUpdate('minDate', e.target.value)}
              className="w-full px-3 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-black bg-white select-text"
            />
            <p className="mt-1 text-xs text-gray-500">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleValidationUpdate('maxDate', e.target.value)}
              className="w-full px-3 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-black bg-white select-text"
            />
             <p className="mt-1 text-xs text-gray-500">
            ...
            <div>
               ...
               <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleOptionUpdate('showTime', e.target.checked)}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all after:duration-300 after:ease-in-out after:shadow-sm peer-checked:bg-black"></div>
                </label>
              ...
              <div className="flex flex-col gap-2">
                 <div className="flex rounded-md overflow-hidden border border-gray-300">
                    {['NONE', 'current', 'custom'].map((mode) => (
                      <button
                        key={mode}
                        onClick={() => handleOptionUpdate('defaultDate', mode === 'current' ? 'current' : mode === 'custom' ? 'custom' : 'none')}
                         className={`flex-1 px-3 py-2 text-xs font-bold transition-colors ${
                          (options.defaultDate === mode) || (!options.defaultDate && mode === 'NONE')
                             ? 'bg-black text-white'
                            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                        }`}
                      >
                       {mode === 'NONE' ? t('builder.properties.default_date_none') : mode === 'current' ? t('builder.properties.default_date_current') : t('builder.properties.default_date_custom')}
                      </button>
                    ))}
                  </div>
                  ...
                  {options.defaultDate === 'custom' && (
                     <input
                        ...
                        onChange={(e) => handleOptionUpdate('customDefaultDate', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-black bg-white select-text"
                      />
                  )}
              </div>
