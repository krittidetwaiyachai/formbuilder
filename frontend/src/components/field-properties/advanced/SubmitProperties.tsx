...
import type { Field, SubmitField, SubmitFieldOptions } from "@/types";
...
export const SubmitProperties: React.FC<SubmitPropertiesProps> = ({
  field: rawField,
  updateField,
  duplicatesField,
}) => {
              ...
              {(["LEFT", "CENTER", "RIGHT"] as const).map((align) => (
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-md border transition-colors ${
                    options.buttonAlign === align ||
                    (!options.buttonAlign && align === "LEFT") // Default to LEFT if undefined
