...
export function MatrixProperties({
  ...
  const [activeTab, setActiveTab] = useState<"general" | "fields" | "advanced">(
    "general"
  );
  ...
  { id: "r1", label: t("builder.properties.question") + " 1" }];
  ...
  const addRow = () => {
    ...
    {
      id: newId,
      label: `${t("builder.properties.question")} ${rows.length + 1}`
    }]
    );
  };
                ...
                <Draggable
                  ...
                  <div
                    ...
                    className="flex items-center gap-2 group">
                      ...
                      value={row.label}
                      onChange={(e) =>
                      updateRowLabel(index, e.target.value)
                      }
