...
export const PhoneProperties = ({
  ...
  const handleOptionUpdate = <K extends keyof PhoneFieldOptions,>(
  key: K,
  value: PhoneFieldOptions[K]) =>
  {
    handleUpdate({
      options: {
        ...options,
  ...
  const handleValidationUpdate = <K extends keyof PhoneValidation,>(
  key: K,
  value: PhoneValidation[K]) =>
  {
    handleUpdate({
      validation: {
        ...validation,
