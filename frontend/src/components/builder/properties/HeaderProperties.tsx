...
export default function HeaderProperties({
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        toast({
          title: t("error.image_uploaded.title"),
          description: t("error.image_uploaded.message"),
          variant: "default"
        });
      };
  ...
  const handleRemoveImage = () => {
    ...
    toast({
      title: t("error.image_removed.title"),
      description: t("error.image_removed.message"),
      variant: "default"
    });
  };
  return (
