...
export const adminApi = {
  ...
  api.post('/admin/settings/system/backup/restore-latest', { confirm: true }),
  listBackups: () =>
  api.get<BackupFileInfo[]>('/admin/settings/system/backup/files'),
  deleteBackup: (fileName: string) =>
  api.delete(`/admin/settings/system/backup/files/${encodeURIComponent(fileName)}`),
  restoreBackup: (fileName: string) =>
  api.post(`/admin/settings/system/backup/restore/${encodeURIComponent(fileName)}`, { confirm: true }),
