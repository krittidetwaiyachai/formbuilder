            ...
            {/* Sub-buttons (Radial Layout) */}
             <div className="absolute inset-0 flex items-center justify-center">
                ...
                <button
                    ...
                    title="Settings"
                >
                    {isMobileMenuOpen && <span className="speed-dial-label" style={{ marginTop: '-50px' }}>Settings</span>}
                ...
                <button
                    ...
                    title="Properties"
                >
                    {isMobileMenuOpen && <span className="speed-dial-label" style={{ marginTop: '0px' }}>Properties</span>}
                ...
                <button
                    ...
                    title="Add Field"
                >
                    {isMobileMenuOpen && <span className="speed-dial-label">Add Field</span>}
