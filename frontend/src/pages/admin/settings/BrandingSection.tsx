  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <SettingsField
          label={t("admin.settings.system.branding_logo_url")}
          value={logoUrl}
          onChange={setLogoUrl}
          helperText={t("admin.settings.system.branding_logo_helper", "แนะนำสัดส่วน 1:1 เช่น 128x128px หรือ 256x256px ไฟล์ PNG/SVG")} />
