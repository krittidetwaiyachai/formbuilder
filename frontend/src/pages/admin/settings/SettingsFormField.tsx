...
export function SettingsField({ label, value, onChange, type = "text", placeholder, helperText }: SettingsFieldProps) {
  return (
    <div>
      ...
      {helperText && <p className="mt-1.5 text-xs text-gray-400">{helperText}</p>}
    </div>);
}
