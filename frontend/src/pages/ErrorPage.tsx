    ...
    switch (code) {
      case 403:
        return {
          ...
          footer: t(
            "error.footer.security",
            "Security Protocol • Access Level: Restricted",
          ),
        };
      case 500:
        return {
          ...
          footer: t(
            "error.footer.diagnostic",
            "System Diagnostic • Status: Critical",
          ),
        };
      case 503:
        return {
          ...
          footer: t(
            "error.footer.upgrade",
            "System Upgrade • Estimating Time: Unknown",
          ),
        };
      case 404:
      default:
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0a0a] text-white overflow-hidden relative selection:bg-indigo-500/30 font-sans">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[100dvh] w-full px-4 py-8">
        ...
        >
          ...
          >
            <Icon
              className={`w-8 h-8 md:w-12 md:h-12 ${config.color}`}
              strokeWidth={1.5}
            />
          </motion.div>
