...
export default function FormPreviewPage() {
  ...
  const activeForm = (currentForm && currentForm.id === id) ? currentForm : fetchedForm;
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-gray-600 font-medium mb-2">{t('public.form_not_found_title')}</p>
    ...
    <div className="min-h-screen bg-gray-100 select-none">
      ...
      <div className="flex-1 overflow-auto flex items-start justify-center p-4">
        <DeviceFrame device={device}>
          ...
          >
             <PublicFormRenderer form={activeForm} isPreview={true} viewMode={device} />
          </div>
        </DeviceFrame>
      </div>
    </div>
