...
export const FieldDistributionWidget: React.FC<FieldAnalyticsProps & { selectedField: string; onFieldChange: (val: string) => void }> = ({
  fieldStats,
  selectedField,
  onFieldChange,
  onCopy,
...
export const FieldDetailedAnalysis: React.FC<FieldAnalyticsProps & { selectedField: string; onFieldChange: (val: string) => void }> = ({
  fieldStats,
  totalResponses,
  selectedField,
  onFieldChange,
                  ...
                  <div id="distribution-chart" className="p-4 bg-white rounded-lg border border-gray-200">
                      <ResponsiveContainer width="100%" height={300}>
                          <BarChart data={selectedFieldStats.distributionCounts} layout="vertical">
                              ...
                              />
                              <Bar dataKey="count" fill="#000000" name={t('analytics.count')} radius={[0, 8, 8, 0]} isAnimationActive={false} />
                          </BarChart>
                      </ResponsiveContainer>
                  </div>
              </div>
