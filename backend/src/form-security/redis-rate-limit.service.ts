...
RedisRateLimitService {
  ...
  {}
  requireSharedStore() {
    if (!this.redisService.getClient() && !this.allowInMemoryFallback()) {
  ...
  private allowInMemoryFallback() {
    const configured = this.configService.get<string>('ALLOW_IN_MEMORY_RATE_LIMIT');
