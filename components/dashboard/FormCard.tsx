      ...
      <CardFooter className="flex flex-col gap-2">
        <div className="flex gap-2 w-full">
          <Button asChild variant="outline" className="flex-1 justify-center">
            <Link href={`/builder/${form.id}`} className="flex items-center justify-center">
              <FileText className="h-4 w-4 mr-2" />
              Edit
            </Link>
          </Button>
          <Button asChild variant="default" className="flex-1 justify-center">
            <Link href={`/preview/${form.id}`} className="flex items-center justify-center">
              Preview
            </Link>
          </Button>
        </div>
        <div className="flex gap-2 w-full">
          <Button asChild variant="outline" className="flex-1 justify-center">
            <Link href={`/analytics/${form.id}`} className="flex items-center justify-center">
              <BarChart3 className="h-4 w-4 mr-2" />
              Analytics
            </Link>
          </Button>
          <Button asChild variant="outline" className="flex-1 justify-center">
            <Link href={`/activity/${form.id}`} className="flex items-center justify-center">
